...
<body class="d-flex flex-column h-100" style="background-color: #FFF5E4">
    ...
    <div class="container px-5 pt-4" id="shop-body">
        ...
        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    <div class="card-text row row-cols-1">
                                        ...
                                        <div class="col">Name: 
                                            <?php
                                            $cust_query = "SELECT c_firstname,c_lastname FROM customer WHERE c_id = {$og_row['c_id']};";
            ...
            <div class="tab-pane fade p-3" id="nav-rdpk" role="tabpanel" aria-labelledby="rdpk-tab" style="border-radius: 10px">
                <?php 
