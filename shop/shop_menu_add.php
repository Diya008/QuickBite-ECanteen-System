...
<head>
    <?php 
        ...
        if(isset($_POST["add_confirm"])){
            ...
            $insert_query = "INSERT INTO food (f_name,f_price,s_id,f_todayavail,f_preorderavail,f_quantity,veg_nveg) 
            VALUES ('{$f_name}',{$f_price},{$s_id},{$f_todayavail},{$f_preorderavail},{$f_quantity},{$veg_nveg});";
...
<body>
    ...
    <div class="container">
        <form method="POST" action="shop_menu_add.php" class="form-signin" enctype="multipart/form-data">
            <h2><i class="bi bi-plus-circle me-2"></i>Add New Menu</h2>
            ...
            <div class="form-group">
                ...
                <input type="number" step=".25" min="0.00" max="999.75" class="form-control" id="f_price" name="f_price" required>
            </div>

            <div class="form-group">
                <label class="form-label" for="f_quantity">Available Quantity</label>
                <input type="number" min="0" class="form-control" id="f_quantity" name="f_quantity" required>
            </div>
            ...
            <button class="btn btn-success" name="add_confirm" type="submit">Add New Menu</button>
        </form>
    </div>
